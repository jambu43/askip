...
import { fetchLastestArticles } from '../store/actions/articles';
...
class HomeScreen extends React.Component {
	...
	componentDidMount() {
		...
		this.props.fetchLastestArticles();
	}
	render() {
		const { navigation, magazines_publication_releases, latest_podcast, articles, articles_loading } = this.props;
		return (
			<Container>
				<AppHeader />
				<ScrollView>
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		fetchLastestArticles: () => dispatch(fetchLastestArticles())
	};
};
